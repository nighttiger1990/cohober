    ...
    addData() {
        ...
        if (Platform.OS === 'android') {
            ...
            if (validate.isEmpty(this.state.detail)) {
                ...
                Toast.show(this.props.lang.type === 'vi' ? "Vui lòng nhập nội dung ý tưởng" : 'Please type idea content ', Toast.SHORT, Toast.TOP, {
                    height: 50,
                    width: 400,
                    backgroundColor: '#ffca00',
                    opacity: 0.5,
                            ...
                            <TouchableOpacity style={{marginTop: 15 * g.rh}} onPress={() => this.addData()}>
                                <View style={{
                                    ...
                                    <Text style={{
                                        ...
                                        fontWeight: 'bold',
                                        fontFamily: 'Roboto-BoldCondensed'
                                    }}>{(this.props.lang.content.addIdea + "").toUpperCase()}</Text>
                                </View>
                            </TouchableOpacity>
                        </Form>
                    </Content>
