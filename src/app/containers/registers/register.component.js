            ...
            if (this.state.confirmPassword === this.state.password) {
                if (validate.isNumber(parseFloat(this.state.phone))) {
                    if (!validate.isEmpty(this.state.name) && validate.isNumber(parseFloat(this.state.phone))) {
                        ...
                        Toast.show(this.props.lang.type === 'vi' ? "Vui lòng nhập họ và tên" : "Please type full name", Toast.SHORT, Toast.TOP, {
                            height: 50,
                            width: 400,
                            backgroundColor: '#ffca00',
                            opacity: 0.5,
                    ...
                    Toast.show(this.props.lang.type === 'vi' ? "Vui lòng nhập số điện thoại" : "Please type phone number", Toast.SHORT, Toast.TOP, {
                        height: 50,
                        width: 400,
                        backgroundColor: '#ffca00',
                        opacity: 0.5,
                ...
                Toast.show(this.props.lang.type === 'vi' ? "Mật khẩu không trùng khớp" : "Password not match", Toast.SHORT, Toast.TOP, {
                    height: 50,
                    width: 400,
                    backgroundColor: '#ffca00',
                    opacity: 0.5,
