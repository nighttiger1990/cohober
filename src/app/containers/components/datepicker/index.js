...
export default class DatePicker extends Component {
    constructor(props) {
        ...
        this.getDate = this
            .getDate
            .bind(this);
        this.getDateStr = this
            .getDateStr
            .bind(this);
        this.datePicked = this
            .datePicked
            .bind(this);
        this.onPressDate = this
            .onPressDate
            .bind(this);
        this.onPressCancel = this
            .onPressCancel
            .bind(this);
        this.onPressConfirm = this
            .onPressConfirm
            .bind(this);
        this.onDateChange = this
            .onDateChange
            .bind(this);
        this.onPressMask = this
            .onPressMask
            .bind(this);
        this.onDatePicked = this
            .onDatePicked
            .bind(this);
        this.onTimePicked = this
            .onTimePicked
            .bind(this);
        this.onDatetimePicked = this
            .onDatetimePicked
            .bind(this);
        this.onDatetimeTimePicked = this
            .onDatetimeTimePicked
            .bind(this);
        this.setModalVisible = this
            .setModalVisible
            .bind(this);
    }

    componentWillMount() {
        // ignore the warning of Failed propType for date of DatePickerIOS, will remove
        // after being fixed by official
        // if (!console.ignoredYellowBox) {
        //   console.ignoredYellowBox = [];
        // }
        // console
        //   .ignoredYellowBox
        //   .push('Warning: Failed propType');
    }
    ...
    setModalVisible(visible) {
        ...
        if (visible) {
            ...
            return Animated
                .timing(this.state.animatedHeight, {
                    toValue: height,
                    duration: duration
                })
                .start();
    ...
    datePicked() {
        if (typeof this.props.onDateChange === 'function') {
            this
                .props
                .onDateChange(this.getDateStr(this.state.date), this.state.date);
        }
    }
    ...
    onDateChange(date) {
        this.setState({allowPointerEvents: false, date: date});
    ...
    render() {
        ...
        const dateInputStyle = [
            Style.dateInput, customStyles.dateInput, disabled && Style.disabled,
...
DatePicker.defaultProps = {
    ...
    androidMode: 'default',
    date: '',
    // components height: 216(DatePickerIOS) + 1(borderTop) + 42(marginTop), IOS only
    height: 259,
